...
class SignatureForm extends Component {
    ...
    var location = document.getElementById('mymodal');
    ...
    if (data.force_refresh) {
        ...
        // Hide the modal before reloading the page
    ...
    // Hide the modal after the signing process completes
    setTimeout(() => {
        location.style.display = 'none';
    }, 6000);

    // Ensure the button state is restored if there's an error
    restoreBtnLoading();
    button.prepend(icon);
    }
}
